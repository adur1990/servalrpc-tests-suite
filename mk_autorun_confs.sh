...
for d in */*; do
    ...
    echo "core $d \"\" \"$WATCH_AGENT_TIME\" \"$NUM_CALLS\" 0 #3 hub_64" | tee -a autorun_confs/hub.conf >> autorun_confs/full.conf
    echo "core $d \"\" \"$WATCH_AGENT_TIME\" \"$NUM_CALLS\" 0 #3 chain_64" | tee -a autorun_confs/chain.conf >> autorun_confs/full.conf
    echo "core $d \"\" \"$WATCH_AGENT_TIME\" \"$NUM_CALLS\" 0 #3 islands_64" | tee -a autorun_confs/islands.conf >> autorun_confs/full.conf
    ...
    echo "core $d \"\" \"360\" \"5\" 0 #1 chain_4" >> autorun_confs/test.conf
done

# Second special case: combined
echo "core combined \"\" \"$WATCH_AGENT_TIME\" \"$NUM_CALLS\" 0 #3 hub_64" | tee -a autorun_confs/hub.conf >> autorun_confs/full.conf
echo "core combined \"\" \"$WATCH_AGENT_TIME\" \"$NUM_CALLS\" 0 #3 chain_64" | tee -a autorun_confs/chain.conf >> autorun_confs/full.conf
echo "core combined \"\" \"$WATCH_AGENT_TIME\" \"$NUM_CALLS\" 0 #3 islands_64" | tee -a autorun_confs/islands.conf >> autorun_confs/full.conf
...
echo "core combined \"\" \"360\" \"5\" 0 #1 chain_4" >> autorun_confs/test.conf
